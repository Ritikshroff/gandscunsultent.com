...
export default function Home() {
  return (
    // <main className="bg-[#fcf8f8] text-gray-800 font-inter">
    //   {/* SEO Meta Tags */}
    //   <head>
    //     <title>G&S Finance - Business Compliance Made Easy</title>
    //     <meta
    //       name="description"
    //       content="G&S Finance helps you with business compliance, tax filings, and legal services. Fast, affordable, and expert support for your business growth."
    //     />
    //     <meta
    //       name="keywords"
    //       content="business compliance, tax filing, legal services, G&S Finance, registration, India"
    //     />
    ...
    //         We take care of <span className="text-[#1A73E8]">ALL</span> your
    //         business compliance needs
    //       </h2>
    //       <p className="text-gray-600 mb-6">
    //         An online platform helping entrepreneurs with registrations, tax
    //         filings, and legal services—fast, simple, and affordable.
    //       </p>
    //       <a
    //         href="#"
    ...
    //   {/* Comparison Section */}
    //   <section
    //     className="w-full max-w-7xl mx-auto px-4 sm:px-8 py-12 md:py-16 flex flex-col items-center mb-12"
    //     aria-label="Comparison of compliance options"
    //   >
    ...
    //       Compare the traditional way of handling compliance with our
    //       streamlined, expert-driven approach. Save time, money, and stress!
    //     </p>
    ...
    //             Quarterly TDS fillings –{" "}
    //             <span className="ml-1 font-medium">Rs.5,000</span>
    //           </li>
    //           <li className="flex items-center bg-[#f9fafb] border border-gray-200 rounded-lg px-4 py-3">
    //             <span className="text-[#1A73E8] text-xl mr-3">✔️</span>
    //             Board Minutes preparation –{" "}
    //             <span className="ml-1 font-medium">Rs.1,000</span>
    //           </li>
    //           <li className="flex items-center bg-[#f9fafb] border border-gray-200 rounded-lg px-4 py-3">
    //             <span className="text-[#1A73E8] text-xl mr-3">✔️</span>
    //             Annual AOC 4 filing –{" "}
    //             <span className="ml-1 font-medium">Rs.2,000</span>
    //           </li>
    //           <li className="flex items-center bg-[#f9fafb] border border-gray-200 rounded-lg px-4 py-3">
    //             <span className="text-[#1A73E8] text-xl mr-3">✔️</span>
    //             Annual MGT - 7 filing –{" "}
    ...
    //           <li className="flex items-center bg-[#f9fafb] border border-gray-200 rounded-lg px-4 py-3">
    //             <span className="text-[#1A73E8] text-xl mr-3">✔️</span>
    //             DIR 3KYC for all the directors –{" "}
    //             <span className="ml-1 font-medium">Rs.3,000</span>
    //           </li>
    //         </ul>
    //         {/* Yellow badge */}
    ...
    //         <span className="text-xl font-semibold text-gray-500 mt-8">
    //           Or you could
    //         </span>
    //       </div>
    ...
    //           Get all your{" "}
    //           <span className="font-bold text-[#1A73E8]">Compliance</span> done
    //           with the help of{" "}
    //           <span className="font-semibold">Industry Experts</span> and
    //           channelize that precious time to grow your{" "}
    ...
    //   <section
    //     className="w-full max-w-7xl mx-auto px-4 sm:px-8 py-12 mb-12"
    ...
    //           Experience quick turnaround times and a seamless online process
    ...
    //         <p className="text-gray-600">
    //           Our team of professionals ensures you get the right advice and
    ...
    //         <p className="text-gray-600">
    //           Transparent and competitive pricing with no hidden charges—get
    ...
    //   <section
    //     className="w-full max-w-4xl mx-auto px-4 sm:px-8 py-12 mb-12"
    ...
    //           We offer business compliance, tax filing, legal services, and
    //           expert support for entrepreneurs and growing businesses.
    //         </p>
    //       </details>
    //       <details className="bg-white rounded-lg shadow p-6 group">
    //         <summary className="font-semibold text-[#1A73E8] cursor-pointer group-open:text-[#1666c1] transition">
    ...
    //         </summary>
    //         <p className="text-gray-700 mt-2">
    //           Our team responds to all queries within 24 hours, ensuring you get
    ...
    //         </summary>
    //         <p className="text-gray-700 mt-2">
    //           Yes, we use industry-standard security practices to keep your
